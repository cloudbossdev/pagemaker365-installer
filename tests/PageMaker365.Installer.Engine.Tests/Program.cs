...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var tests = new (string Name, Func<Task> Run)[]
        {
            ...
            ("Private runtime delivery v0.7 locks accepted producer bytes and validates the closed projection", PrivateRuntimeDeliveryV07FixtureTests.LocksAcceptedProducerBytesAndValidatesClosedPackage),
            ("Private runtime delivery v0.7 rejects cross-pairs, noncanonical bytes, and catalog drift", PrivateRuntimeDeliveryV07FixtureTests.RejectsCrossPairsCanonicalAndCatalogDrift),
            ("Private runtime delivery v0.7 rejects incomplete, unsafe, forbidden, and raw configuration", PrivateRuntimeDeliveryV07FixtureTests.RejectsIncompleteUnsafeOrRawConfiguration),
            ("Private runtime delivery v0.7 remains parser-only and preserves historical consumers", PrivateRuntimeDeliveryV07FixtureTests.RemainsParserOnlyAndPreservesHistoricalConsumers),
