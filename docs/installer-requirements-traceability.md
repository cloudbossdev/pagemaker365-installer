...
| US-02 Acquire package | Package | P01-P09 | Engine/API and app package tests plus default-disabled package 0.6 / manifest 3.0 fixture, compatibility, full/range, integrity, and transport-denial tests | Fresh staging setup-file acquisition has been exercised; v0.6 remains synthetic/local and expiry/reuse staging evidence is pending | User and technical drafts | Partial | [#4](https://github.com/cloudbossdev/pagemaker365-installer/issues/4) |
...
| US-04 Authenticate | Sign In | A01-A09 | Engine Graph cancellation/expiry, Azure cancellation, token validation, and dual-sign-in gating app tests | Interactive staging cancellation/expiry confirmation pending | User and technical drafts | Partial | [#4](https://github.com/cloudbossdev/pagemaker365-installer/issues/4) |
| US-05 Preflight | Preflight | F01-F12 | PowerShell preflight, mandatory blocker-policy, Azure role-set, provider/SKU/quota readiness, SharePoint denial, Key Vault recovery, and contract tests | Live permission, SharePoint-denial, tenant-policy, and allocation-time capacity evidence pending | User and technical drafts | Partial | [#4](https://github.com/cloudbossdev/pagemaker365-installer/issues/4) |
...
| US-07 Clean install | Install | L01, L04, D06-D10 | Deployment, runtime-secret contract, protected-input, Key Vault reference, state-leakage, and artifact tests | Azure resources deployed previously; fresh `0.4` package runtime provisioning proof pending | User and technical drafts | Implemented | [#5](https://github.com/cloudbossdev/pagemaker365-installer/issues/5), [#7](https://github.com/cloudbossdev/pagemaker365-installer/issues/7) |
...
| Runtime artifact delivery | Package 0.6 / manifest 3.0 private acquisition is locally verified, but no private-byte deployment bridge exists; 19 mandatory settings and the fourth protected reference also remain separate blockers before reproducible deployment and deployment-bound health evidence | [#5](https://github.com/cloudbossdev/pagemaker365-installer/issues/5) |
| Runtime secret inventory and source | `0.4` contract and local protected provisioning tests implemented; fresh signed staging package and live reference-resolution evidence remain | [#7](https://github.com/cloudbossdev/pagemaker365-installer/issues/7) |
