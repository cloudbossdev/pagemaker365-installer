...
| US-05 Preflight | Preflight | F01-F12 | PowerShell preflight, Azure role-set, provider/SKU/quota readiness, Key Vault recovery, and contract tests | Live permission, SharePoint-denial, and allocation-time capacity evidence pending | User and technical drafts | Partial | [#4](https://github.com/cloudbossdev/pagemaker365-installer/issues/4) |
