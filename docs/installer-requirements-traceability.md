...
| US-12 Troubleshoot and support | Guidance, support bundle | T01-T06 | Assistant endpoint, trusted-origin, redaction, attachment, exact-draft, fallback, and local-action-policy tests plus support-bundle checks | Execute `docs/testing/assistant-support-handoff.md`; portal retention and customer-approved handoff review pending | User and technical drafts | Partial | [#28](https://github.com/cloudbossdev/pagemaker365-installer/issues/28) |
