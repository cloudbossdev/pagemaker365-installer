...
| US-06 Preview and approve | Preview, Install gate | L01, D01-D05 | What-if, approval, and package/preview/artifact execution-binding tests | Warning/no-change/capacity variants pending | User guide draft | Implemented | [#10](https://github.com/cloudbossdev/pagemaker365-installer/issues/10) |
...
| US-08 Upgrade | Package, preflight, preview, install/update, validate | U01-U08 | Semantic-version policy, immutable execution binding, saved-session forward-fix authorization, ordered terminal lifecycle, exact receipt, redaction, and Azure identity tests | Patch/minor, partial-mutation recovery, data preservation, and portal staging runs pending | User, technical, and upgrade contract drafts | Implemented | [#6](https://github.com/cloudbossdev/pagemaker365-installer/issues/6) |
...
| Upgrade compatibility | Installer version/source identity, immutable preview binding, saved-session forward-fix, ordered evidence, and exact receipt enforcement implemented; portal generation/acceptance and live upgrade evidence remain | [#6](https://github.com/cloudbossdev/pagemaker365-installer/issues/6) |
