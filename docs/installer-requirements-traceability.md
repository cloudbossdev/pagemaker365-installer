...
| US-05 Preflight | Preflight | F01-F12 | PowerShell preflight, mandatory blocker-policy, Azure role-set, SharePoint denial, Key Vault recovery, and contract tests | Live permission/quota and tenant-policy evidence pending | User and technical drafts | Partial | [#4](https://github.com/cloudbossdev/pagemaker365-installer/issues/4) |
