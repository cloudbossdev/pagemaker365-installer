...
| US-08 Upgrade | Package, preflight, preview, install/update, validate | U01-U08 | Semantic-version policy, signed intent, Azure source identity, immutable tag, active deployment, and callback-shape tests | Patch/minor, recovery, data preservation, and portal staging runs pending | User, technical, and upgrade contract drafts | Implemented | [#6](https://github.com/cloudbossdev/pagemaker365-installer/issues/6) |
...
| Upgrade compatibility | Installer version/source identity/preview/recovery contract implemented; portal generation/callbacks and live upgrade evidence remain | [#6](https://github.com/cloudbossdev/pagemaker365-installer/issues/6) |
