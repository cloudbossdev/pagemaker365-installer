...
- The Install step requests only the protected values declared by the verified customer package. It identifies any value generated by the installer, keeps entered values only for the current attempt, and clears the fields when the attempt ends.
