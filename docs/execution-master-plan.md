...
Needs customer: provide a real CloudBoss installer package contract from the portal `install-package` endpoint.
...
- Phase 2.3 is currently blocked because no real CloudBoss installer package contract exists locally.
