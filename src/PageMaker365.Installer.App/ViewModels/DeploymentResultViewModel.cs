...
public sealed class DeploymentResultViewModel
{
    public DeploymentResultViewModel(InstallerStepResult result)
    {
        ...
        ApprovalLabel = result.RequiresApproval ? "Approval required" : "Approved";
